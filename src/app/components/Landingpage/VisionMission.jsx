...
const VisionMission = () => {
  return (
    <div className='bg-[#e0e0ddc8] pt-10'>
    <div className="py-24 px-4 sm:px-6 lg:px-8 ">
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
        {/* Vision Card */}
        <div className="w-80 transform hover:scale-105 transition-transform duration-300">
          <div className="bg-[#000957] text-white shadow-lg p-8 rounded-xl" style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
            <div className="text-center py-4">
              <div className="flex justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-red-600" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                </svg>
              </div>
              <h3 className="text-3xl font-semibold text-white mb-2">Our Vision</h3>
        ...
        {/* Core Values Card */}
        <div className="w-80 transform hover:scale-105 transition-transform duration-300 md:mt-[-240px]">
          <div className="bg-[#000957] shadow-lg p-8 rounded-xl" style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
            <div className="text-center py-4">
              <div className="flex justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-red-600" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              ...
              <h3 className="text-3xl font-semibold text-white mb-2">Core Values</h3>
              <div className="w-16 h-0.5 bg-gray-300 mx-auto mb-4">
                <div className="w-8 h-0.5 bg-red-400"></div>
              </div>
              <p className="text-white font-bold text-md p-0">
        ...
        <div className="w-80 transform hover:scale-105 transition-transform duration-300">
          <div className="bg-[#000957] shadow-lg p-8 rounded-xl" style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
            <div className="text-center py-4">
              ...
              <h3 className="text-3xl font-semibold text-white mb-2">Our Mission</h3>
              <div className="w-16 h-0.5 bg-gray-300 mx-auto mb-4">
                <div className="w-8 h-0.5 bg-red-400"></div>
              </div>
              <p className="text-white font-bold text-md px-2">
