...
//     { id: "login", label: "Login", icon: <LogIn className="w-6 h-6" /> },
//   ];
...
const CompanyDetails = ({ company }) => {
  ...
  const sidebarItems = [
    { id: "home", label: "Home", icon: <Home className="w-6 h-6" /> },
    { id: "about-us", label: "About Us", icon: <Info className="w-6 h-6" /> },
    { id: "management", label: "Management", icon: <UserCog className="w-6 h-6" /> },
    { id: "certification", label: "Certification", icon: <Award className="w-6 h-6" /> },
    { id: "services", label: "Services", icon: <HeartHandshake className="w-6 h-6" /> },
    { id: "clients", label: "Clients", icon: <Users className="w-6 h-6" /> },
    { id: "product", label: "Product", icon: <Package className="w-6 h-6" /> },
    { id: "contact", label: "Contact Us", icon: <Phone className="w-6 h-6" /> },
    { id: "login", label: "Login", icon: <LogIn className="w-6 h-6" /> },
  ];
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100 relative">
      ...
      <div
        className={`bg-[#344742] text-white transition-all duration-300 ${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
        } ${isSidebarOpen ? "md:w-48" : "md:w-24"} md:sticky md:top-0 md:h-screen fixed w-64 h-full overflow-y-auto shadow-lg z-50`}
      >
